<template>
  <div class="spaceview">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="400" height="800" id="space" ref="sheets">
      <!--  -->
      <!-- GET ALL OTHERCLIENTS IN ANOTHER GROUP NOT WITH YOUR DEVICE -->
      <g v-for="(value, index) in otherclients" :key="index">
        ...
        >
          ...
          <g v-for="(connection, index) in value.doc.connections" :key="index">
...
export default {
  ...
  methods: {
    ...
    openSelected(e) {
      // FIXME: Only is your device created it ??
